...
document.addEventListener("DOMContentLoaded", function(event) { 
    ...
    function run(){
        ...
        function check(){
                ...
                if(ch >= num-1){
                    document.getElementById("progress").innerHTML = "CONGRATULATIONS!!!";
                }else{
                    var maij = Math.rand(1, 2);
                    if (maij = 1) {
                        document.getElementById("progress").innerHTML = "You can do it";
                    }
                    if (maij = 2) {
                        document.getElementById("progress").innerHTML = "I believe in you";
                    }
                }
        }
